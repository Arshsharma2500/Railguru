...
function parstatus(){
    ...
    .then((response)=>{
        ...
        if (response.error === "PNR info not found. PNR data not found.")
         {
            let m = "पी एन आर नम्बर गलत है भाई टिकट पे देख के फिर से डाल!";
            let m2 = "Please Enter Valid PNR Number brother, it is mentioned on the top of your Ticket"
            ...
            alert("Please Enter Valid PNR Number, it is mentioned on the top of your Ticket पी एन आर नम्बर गलत है भाई टिकट पे देख के फिर से डाल!")
        }
